#!/usr/bin/env python3
"""Build dataset_mix_v2.txt from multiple sources.
...
Process:
  ...
  3. Cap per-class counts with reproducible sampling (seed 13):
     ...
     - HARD: max 4000
     - INJECTION: max 6000
  4. Shuffle and write dataset_mix_v2.txt

Output: dataset_mix_v2.txt at repo root (LABEL || TEXT per line)
"""
...
SEED = 13
OUTPUT_FILE = "dataset_mix_v2.txt"
